    ...
    <td height="15" align="left" valign="top">&nbsp;</td>
      <td height="15" align="left" valign="top" class="12"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  <form action="admin_products_show.do" method="post" name="form" id="form">
  <DIV class=padding>
  <DIV id=middlebody>
  <table width="100%">
    <tbody>
      ...
      <tr bgcolor="#fba661" height="30">
        ...
        <td><div align="center">删除</div></td>
             ...
             <tr bgcolor="#f3f3f3" height="25">
                ...
                <td><div align="center"><a  href="update_products_admin.do"><img height="20" alt="修改" src="images/button/update1.gif" width="20" border="0" /></a></div></td>
